...
#Preview("New Born Baby") {
    ...
    GenderSelectionView(selectedGender: $selectedGender, segments: mockSegments, isBorn: true)
}


#Preview("Not Born Baby") {
    @Previewable @State var selectedGender: String = "male" // Default selected gender for preview
    let mockSegments = [
        Segment(tag: "male", title: "남아", ),
        Segment(tag: "female", title: "여아"),
    ...
    GenderSelectionView(selectedGender: $selectedGender, segments: mockSegments, isBorn: false)
}
