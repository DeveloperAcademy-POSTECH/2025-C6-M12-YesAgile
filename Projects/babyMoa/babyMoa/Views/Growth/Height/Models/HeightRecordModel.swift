...
struct HeightRecordModel: Identifiable {
    ...
    var monthLabel: String     // "13개월" -> var로 변경
    let dateText: String       // "2025. 10. 21."
    var diffText: String?      // "+0.1" 또는 nil -> var로 변경
    ...
    init(babyId: Int, monthLabel: String, dateText: String, diffText: String?, valueText: String) {
        ...
        // Parse date
        self.date = DateFormatter.yyyyDashMMDashdd.date(from: dateText) ?? Date() // yyyyDashMMDashdd 사용
...
extension HeightRecordModel {
    static let mockData: [HeightRecordModel] = [
        // dateText 형식을 "yyyy-MM-dd"로 변경하여 DateFormatter.yyyyDashMMDashdd와 일관성 유지
