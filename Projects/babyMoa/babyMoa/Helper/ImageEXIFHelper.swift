...
/// **사용 예시:**
/// ```swift
/// if let location = ImageEXIFHelper.extractLocation(from: imageData) {
...
///
/// **참고:**
/// - Instagram, WhatsApp 등 대부분의 앱이 EXIF 방식 사용
/// - PHAsset 방식보다 빠르고 안정적
struct ImageEXIFHelper {
    
    /// 이미지 Data에서 EXIF GPS 정보 추출
    /// - Parameter imageData: 이미지 Data (JPEG, PNG 등)
    /// - Returns: GPS 위치 정보 (없으면 nil)
