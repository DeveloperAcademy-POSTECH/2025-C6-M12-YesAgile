...
protocol BabyMoaServicable: HTTPClient {
    ...
    func postRegisterBaby(alias: String, name: String, birthDate: String, gender: String, avatarImageName: String, relationshipType: String) async -> Result<BaseResponse<RegisterBabyResModel>, RequestError>
}
...
class BabyMoaService: BabyMoaServicable {
    func postRegisterBaby(
        ...
        let result = await request(endpoint: BabyMoaEndpoint.registerBaby(
            alias: alias,
            name: name,
            birthDate: birthDate,
            gender: gender,
        ...
        case .failure(let error):
            ...
            case .unauthorized:
                ...
                return await self.postRegisterBaby(alias: alias, name: name, birthDate: birthDate, gender: gender, avatarImageName: avatarImageName, relationshipType: relationshipType)
            default:
                return result
            }
        }
